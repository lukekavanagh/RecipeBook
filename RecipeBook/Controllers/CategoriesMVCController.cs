...
namespace RecipeBook.Controllers
{
    public class CategoriesMVCController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,ImageLink")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,ImageLink")] Category category)
        {
            if (ModelState.IsValid)
            {
